<?php /*a:3:{s:58:"D:\app\boxin\boxin\application\admin\view\index\index.html";i:1636532180;s:60:"D:\app\boxin\boxin\application\admin\view\public\header.html";i:1636531793;s:58:"D:\app\boxin\boxin\application\admin\view\public\menu.html";i:1636533028;}*/ ?>
<!doctype html>
<html class="x-admin-sm">
    <head>
        <meta charset="UTF-8">
        <title>后台登录-博信巴巴</title>
    ...
    <body class="index">
        ...
        <div class="container">
            <div class="logo">
                <a href="./index.html">博信巴巴 后台管理系统</a></div>
            <div class="left_open">
            ...
            <div id="side-nav">
                <ul id="nav">
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a onclick="xadmin.add_tab('统计页面','/admin/count/index.html')">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>统计页面</cite></a>
                            </li>
                           
                            <li>
                                <a onclick="xadmin.add_tab('会员列表','/admin/members/list.html',true)">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>会员列表()</cite></a>
                            </li>
